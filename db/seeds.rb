...
user = User.create!([{name: "David Shengrow", email: "dshengrow@email.com", password: "password"}])
user = User.create!([{name: "Peter Jeng", email: "pjeng@email.com", password: "password"}])
user = User.create!([{name: "Jay Wengrow", email: "jwengrow@email.com", password: "password"}])
